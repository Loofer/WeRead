...
import org.loofer.weread.mvp.ui.activity.HomeActivity;
...
public class AudioPlayBackService extends Service implements IAudioPlayBack, IAudioPlayBack.Callback {


    private static final String ACTION_PLAY_TOGGLE = "org.loofer.weread.ACTION.PLAY_TOGGLE";
    private static final String ACTION_PLAY_LAST = "org.loofer.weread.ACTION.PLAY_LAST";
    private static final String ACTION_PLAY_NEXT = "org.loofer.weread.ACTION.PLAY_NEXT";
    private static final String ACTION_STOP_SERVICE = "org.loofer.weread.ACTION.STOP_SERVICE";
...
//        LogUtils.d("onUnbind");
     ...
     */
    private void showNotification(AudioPlayState status) {
