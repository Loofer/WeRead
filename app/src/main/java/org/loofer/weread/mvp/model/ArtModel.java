 ...
 * ==========================================================
 */
public class ArtModel extends BaseModel<ServiceManager, CacheManager> implements ArtContract.Model {
    private Gson mGson;
    private Application mApplication;

    public ArtModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
