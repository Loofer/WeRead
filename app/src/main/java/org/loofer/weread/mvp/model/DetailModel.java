...
public class DetailModel extends BaseModel<ServiceManager, CacheManager> implements DetailContract.Model {
    ...
    @Override
    public Observable<BaseJson<Detail>> getDetail(String api, String type, String itemId, int showSdv){
        return mServiceManager.getCommonService().getDetail(api,type,itemId,showSdv);
    }
