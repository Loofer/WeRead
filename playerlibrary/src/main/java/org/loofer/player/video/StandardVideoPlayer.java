...
import org.loofer.player.listener.StandardVideoAllCallBack;
import org.loofer.player.utils.CommonUtil;
import org.loofer.player.utils.Debuger;
import org.loofer.player.utils.NetworkUtils;
import org.loofer.player.widget.ENDownloadView;
import org.loofer.player.widget.ENPlayView;
...
public class StandardVideoPlayer extends VideoPlayer {
    ...
    protected StandardVideoPlayer.DismissControlViewTimerTask mDismissControlViewTimerTask;
    ...
    public BaseVideoPlayer showSmallVideo(Point size, boolean actionBar, boolean statusBar) {
        BaseVideoPlayer gsyBaseVideoPlayer = super.showSmallVideo(size, actionBar, statusBar);
        if (gsyBaseVideoPlayer != null) {
            StandardVideoPlayer gsyVideoPlayer = (StandardVideoPlayer) gsyBaseVideoPlayer;
            gsyVideoPlayer.setStandardVideoAllCallBack(mStandardVideoAllCallBack);
        }
    ...
    private void startDismissControlViewTimer() {
        ...
        mDismissControlViewTimerTask = new StandardVideoPlayer.DismissControlViewTimerTask();
