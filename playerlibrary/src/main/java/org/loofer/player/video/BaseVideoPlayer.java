package org.loofer.player.video;
...
import org.loofer.player.R;
import org.loofer.player.SmallVideoTouch;
import org.loofer.player.VideoManager;
import org.loofer.player.VideoPlayer;
import org.loofer.player.VideoView;
import org.loofer.player.listener.MediaPlayerListener;
import org.loofer.player.listener.VideoAllCallBack;
import org.loofer.player.utils.CommonUtil;
import org.loofer.player.utils.Debuger;
...
import static org.loofer.player.utils.CommonUtil.getActionBarHeight;
import static org.loofer.player.utils.CommonUtil.getStatusBarHeight;
import static org.loofer.player.utils.CommonUtil.hideNavKey;
import static org.loofer.player.utils.CommonUtil.hideSupportActionBar;
import static org.loofer.player.utils.CommonUtil.showNavKey;
import static org.loofer.player.utils.CommonUtil.showSupportActionBar;
...
public abstract class BaseVideoPlayer extends FrameLayout implements MediaPlayerListener {
    ...
    protected VideoView mTextureView;
     ...
     * 恢复
     */
    private void resolveNormalVideoShow(View oldF, ViewGroup vp, VideoPlayer gsyVideoPlayer) {
